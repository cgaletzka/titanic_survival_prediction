...
This repository contains a complete machine learning workflow for the Kaggle competition "Titanic: Machine Learning from Disaster".
...
- Proper preprocessing using scikit-learn Pipelines
